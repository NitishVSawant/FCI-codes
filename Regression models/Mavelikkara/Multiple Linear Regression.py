...
dataset = pd.read_csv('Mavelikkara Regression.csv')
...
plt.figure()
plt.scatter(X_mod, y_train, color = 'red')
plt.plot(X_mod, regressor.predict(X_mod), color = 'blue')
plt.title('Demurrage hours vs Number of wagons placed (Training set)')
plt.xlabel('Number of wagons placed')
plt.ylabel('Demurrage hours')
plt.show()

# Visualising the Test set results
plt.figure()
plt.scatter(X_test[:,b], y_test, color = 'red')
plt.plot(X_mod, regressor.predict(X_mod), color = 'blue')
plt.title('Demurrage hours vs Number of wagons placed (Test set)')
plt.xlabel('Number of wagons placed')
plt.ylabel('Demurrage hours')
plt.show()
...
if(regressor.predict([[X9]]))<=0:
    print('\n\tDemurrage Cost will not occur')
else:
    k=regressor.predict([[X9]])
